...
<script>
  ...
  <body>
    ...
    <div class="container">
        ...
        <form:form method="POST" modelAttribute="userForm"  class="form-signup" id="userForm">
		   ...
		   <spring:bind path="ContactPointsFatherPhoneNumber">
            ...
            <%--
        	<spring:bind path="profileImage">
	        	
	  				<div class="custom-file">
	    				<form:input type="file" path="profileImage"  class="custom-file-input form-control" id="customFile"/>
	    				<form:label class="custom-file-label form-control" path="profileImage" for="customFile">Choose file</form:label>
	  				</div>
