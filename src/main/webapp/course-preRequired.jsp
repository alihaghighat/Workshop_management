...
<html lang="en">
    <head>
        ...
        <title>PreRequireds|Workshop</title>
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <thead>
                                        <th></th>
                                            ...
                                            <th >remove pre Requier</th>
                                    </thead>
                                   
                                    <tbody>

                                     <c:forEach items="${pre_courses}" var="course">
                                        <a href="#">
                                        <tr>
                                            <td></td>
                                            <td>${course.getPreRequired().getId()}</td>
                                            <td><a href="#">
                                                   
                                            </a></td>
                                            <td>
                                               ${course.getPreRequired().getSubject()}
                                            ...
                                            <td>
                                                     <a href="${context}/remove_preRequired?id=${course.getPreRequired().getId()}&workshop_id=${workshop_id}" style="color: #000000;;"><button data-toggle="tooltip" title="remove from perRequireds"  class="pd-setting-ed"><i class="fa fa-trash" aria-hidden="true"></i></button></a>
                                    ...
                                    <tbody>
                                     ...
                                     <c:forEach items="${all_courses}" var="course">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                     <a href="${context}/add_preRequired?id=${course.getId()}&workshop_id=${workshop_id}" style="color: #000000;;"><button data-toggle="tooltip" title="Add to perRequireds"  class="pd-setting-ed"><i class="fa fa-plus" aria-hidden="true"></i></button></a>
