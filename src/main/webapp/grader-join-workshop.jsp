                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="basic-login-inner inline-basic-form">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <form method="GET" action="/grader-join-new-workshop">
                                                                    ...
                                                                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                        <input type="text" name="info" class="form-control basic-ele-mg-b-10 responsive-mg-b-10" placeholder="Enter request information " />
                                                                    </div>
