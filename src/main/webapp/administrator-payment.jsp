...
<html lang="en">
    <head>
        ...
        <title>Administrator show payment |Workshop</title>
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <c:forEach items="${pays}" var="pay" varStatus="theCount">
                                        <tr>
                                            ...
                                            <td><a href="#">
                                            ${users.get(myCount.index).getFirstname()} ${users.get(myCount.index).getLastname()}
                                            </a></td>
                                            <td>${users.get(myCount.index).getUsername()}</td>
                                            <td>${workshops.get(myCount.index).getWorkshop().getSubject()}</td>
                                            <td >
                                            </td>
                                            <td></td>
                                            <td>${dates.get(myCount.index)}</td>
                                            <td>${workshops.get(myCount.index).getPrice()}</td>
                                            <td>
                                            ${pay.isPayed()}
                                            </td>
                                        </tr>
