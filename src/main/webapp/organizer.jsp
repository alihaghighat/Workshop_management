...
<html lang="en">
    <head>
        ...
        <title>Organizer |Workshop</title>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="social-media-edu">
                            ...
                            <div class="social-edu-ctn">
                                <h3><a href="${context}/form-organizer?id=${id}" class="">forms</a></h3>
                                <p>You can build the form and complete the form.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="social-media-edu twitter-cl res-mg-t-30 table-mg-t-pro-n">
                            ...
                            <div class="social-edu-ctn">
                                <h3><a href="${context}/organizer-grader?id=${id}" >grader</a></h3>
                                <p>Access to all Grader and Grader appointments</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="social-media-edu linkedin-cl res-mg-t-30 res-tablet-mg-t-30 dk-res-t-pro-30">
                            ...
                            <div class="social-edu-ctn">
                                <h3><a href="${context}/organizer-workshop?id=${id}">workshops</a></h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="social-media-edu youtube-cl res-mg-t-30 res-tablet-mg-t-30 dk-res-t-pro-30">
                            ...
                            <div class="social-edu-ctn">
                                <h3><a href="${context}/organizer-payment?id=${id}" >payments</a></h3>
