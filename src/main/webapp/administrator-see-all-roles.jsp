...
<html lang="en">
    <head>
        ...
        <title>Show hte Roles |Workshop</title>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr">
                                            <p><b>First name</b><br /> ${user_info.getFirstname()}  </p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr tb-sm-res-d-n dps-tb-ntn">
                                            <p><b>Last name</b><br /> ${user_info.getLastname()}   </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr">
                                            <p><b>Username</b><br /> ${user_info.getUsername()}</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr tb-sm-res-d-n dps-tb-ntn">
                                            <p><b>Email</b><br /> ${user_info.getContactPointsEmail()}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr">
                                            <p><b>Phone number</b><br /> ${user_info.getContactPointsPhoneNumber()}</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr tb-sm-res-d-n dps-tb-ntn">
                                            <p><b>Address</b><br /> ${user_info.getContactPointsAddress()}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr">
                                            <p><b>Gender</b><br /> ${user_info.getGender()}</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr tb-sm-res-d-n dps-tb-ntn">
                                            <p><b>Nationality</b><br /> ${user_info.getNationality()}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <tbody>
                                     ...
                                     <c:forEach items="${all_roles}" var="role" varStatus="theCount">
                                        <a href="#">
                                        <tr>
                                            <td></td>
                                            <td>${role.getId()}</td>
                                            ...
                                            <td>
                                               ${all_roles_subjects.get(theCount.index)}
