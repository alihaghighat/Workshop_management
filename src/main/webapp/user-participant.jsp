                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1>All participant roles</h1>
                            </div>
                        </div>
                        <div class="add-product">
                                    <a href="${context}/join-workshop">Join workshop</a>
                        </div>
                        <div class="sparkline13-graph">
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <tbody>
                                    <c:forEach items="${students}" var="student" varStatus="myCount">
                                        <tr>
                                            <td></td>
                                            <td>${student.getId()}</td>
                                            <td><a href="#">
                                            ${workshops.get(myCount.index).getWorkshop().getSubject()}
                                            </a></td>
                                            <td>${workshops.get(myCount.index).getLocation()}</td>
                                            <td></td>
                                            <td >
                                            ...
                                            <td></td>
                                            <td>
                                            <a href="${context}/participant?id=${student.getId()}" style="color: #000000;;"><button data-toggle="tooltip" title="see"  class="pd-setting-ed"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                                            </td>
                                        </tr>
                                    </c:forEach>                                         
                                    </tbody>
