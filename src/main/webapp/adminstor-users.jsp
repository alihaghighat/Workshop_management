...
<html lang="en">
    <head>
        ...
        <title>All user roles | Workshop</title>
                    ...
                    <div class="left-custom-menu-adp-wrap comment-scrollbar">
                        <nav class="sidebar-nav left-sidebar-menu-pro">
                            <ul class="metismenu" id="menu1">
                                ...
                                <li class="active active-menu-slidbour">
                                    <a class="has-arrow" href="${context}/home">
                                    ...
                                    <ul class="submenu-angle " aria-expanded="true">
                                        <li><a title="Dashboard v.1" href="${context}/adminstor"><span  style="color:#4568dc;" class=" fa fa-circle"></span>adminstor</a></li>
                                    </ul>
                                    <ul class="submenu-angle " aria-expanded="true">
                                        <li><a title="Dashboard v.1" href="${context}/home"><span class="mini-sub-pro ">participant</span></a></li>
                                    </ul>
                                    <ul class="submenu-angle" aria-expanded="true">
                                        
                                        <a class="" href="${context}/home">
                                            <span class="mini-sub-pro "></span>
                                                organizer
                                         </a>
                                    </ul>
                                    <ul class="submenu-angle" aria-expanded="true">
                                        <li><a title="Dashboard v.1" href="${context}/home"><span class="mini-sub-pro">grader</span></a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="">
                                    ...
                                    <ul class="submenu-angle" aria-expanded="true">
                                        ...
                                        <li><a title="Dashboard v.1" href="${context}/home"><span class="mini-sub-pro ">add new work shop</span></a></li>
                                        <li><a title="Dashboard v.1" href="${context}/home"><span class="mini-sub-pro">grader requseting</span></a></li>
                                    </ul>
                                </li>
                                <li class="">
                                    <a class="has-arrow" href="${context}/home">
                                           <span class=" fa fa-paper-plane"></span>
                                             <span class="mini-click-non">Request</span>
                                        </a>
                                ...
                                <li class="">
                                    ...
                                    <ul class="submenu-angle" aria-expanded="true">
                                        <li><a title="Dashboard v.1" href="${context}/home"><span class="mini-sub-pro">all payment</span></a></li>
                                        <li><a title="Dashboard v.1" href="${context}/home"><span class="mini-sub-pro">Installments</span></a></li>
                                        <li><a title="Dashboard v.1" href="${context}/home"><span class="mini-sub-pro">new payment</span></a></li>
                                    </ul>
                                </li>
                            </ul>
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="${context}/administrator-see-all-roles" style="color: #000000;;"><button data-toggle="tooltip" title="see"  class="pd-setting-ed"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                    ...
                    <div class="sparkline10-list mt-b-30">
                        <div class="sparkline10-hd">
                            <div class="main-sparkline10-hd">
                                <h1>Add administrator <span class="basic-ds-n"></span></h1>
                            </div>
                        </div>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                            <input type="email" class="form-control basic-ele-mg-b-10 responsive-mg-b-10" placeholder="Enter username" />
                                                        </div>
