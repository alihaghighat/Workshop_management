...
<html lang="en">
    <meta charset="utf-8">
        ...
        <title> Edit payment  |Workshop</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th ></th>
                                                <td></td>
                                                <th data-field="date" data-editable="true"></th>
                                                <th data-field="price" data-editable="true">Payed installment number</th>
                                                 <th >confirmed</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach items="${pays}" var="pay" varStatus="theCount">
                                            <tr>
                                                <td></td>
                                                <td>${pay.getParticipant().getId()}</td>
                                                <td>${pay.getParticipant().getUser().getFirstname()} ${pay.getParticipant().getUser().getLastname()}</td>
                                                <td>${pay.getParticipant().getUser().getUsername()}</td>
                                                <td></td>
                                                <td >
                                                ...
                                                <td></td>
                                                <td></td>
                                                <form method="GET" action="${context}/savePayment">
                                                   
                                                <td>
                                                 <input value="${pay.getPayment_id()}" class="hide" name="id">
                                                    <input type="number" name="pay_number" value="${values.get(theCount.index)}" min="0" max="${maxes.get(theCount.index)}">
                                                
                                                </td>
                                                <td >
                                                    <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                                                                <div class="login-horizental lg-hz-mg"><button class="btn btn-sm btn-primary login-submit-cs" type="submit">confirmed</button></div>
                                                                            </div>
                                                </td>
                                                </form>
                                            </tr>
