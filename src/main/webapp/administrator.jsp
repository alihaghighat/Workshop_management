...
<html lang="en">
    <head>
        ...
        <title>Adminstartor |Workshop</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <div class="white-box analytics-info-cs mg-b-10 res-mg-b-30 res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            <h3 class="box-title">Number of workshops</h3>
                        ...
                        <div class="white-box analytics-info-cs table-dis-n-pro tb-sm-res-d-n dk-res-t-d-n">
                            <h3 class="box-title">Number of organizer</h3>
                            <ul class="list-inline two-part-sp">
                                <li>
                                    <div id="sparklinedash4"></div>
                                </li>
                                <li class="text-right graph-four-ctn"><i class="fa fa-level-down" aria-hidden="true"></i> <span class="counter text-danger"> <span class="counter text-info">${organizer_numbers}</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="social-media-edu twitter-cl res-mg-t-30 table-mg-t-pro-n">
                            ...
                            <div class="social-edu-ctn">
                                <h3><a  href="${context}/administrator-users" class="">Users</a></h3>
                                <p>View all users and assign roles and other things</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="social-media-edu linkedin-cl res-mg-t-30 res-tablet-mg-t-30 dk-res-t-pro-30">
                            ...
                            <div class="social-edu-ctn">
                                <h3><a href="${context}/administrator-workshop">Workshops</a></h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="social-media-edu youtube-cl res-mg-t-30 res-tablet-mg-t-30 dk-res-t-pro-30">
                            ...
                            <div class="social-edu-ctn">
                                <h3><a href="${context}/administrator-payment" >Payments</a></h3>
                                <p>See all payments and confirm and reject</p>
                            </div>
                        </div>
                    </div>
                </div>
