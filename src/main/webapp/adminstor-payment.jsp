...
<html lang="en">
    <head>
        ...
        <title>See All payments |Workshop</title>
                        ...
                        <nav class="sidebar-nav left-sidebar-menu-pro">
                            <ul class="metismenu" id="menu1">
                                ...
                                <li class="active active-menu-slidbour">
                                    ...
                                    <ul class="submenu-angle" aria-expanded="true">
                                        <li><a title="Dashboard v.1" href="${context}/grader"><span class="mini-sub-pro">grader</span></a></li>
                                    </ul>
                                </li>
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="name" >firstname last name</th>
                                            <th data-field="email" > username</th>
                                            <th data-field="phone" > workshop</th>
                                            <th ></th>
                                            <th></th>
