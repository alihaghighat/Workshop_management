                        ...
                        <div class="product-status-wrap">
                            ...
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <c:forEach items="${graders}" var="grader" varStatus="myCount">
                                    <tr>
                                        <td>${grader.getId()}</td>
                                        <td>${grader.getUser().getFirstname()} ${grader.getUser().getLastname()}</td>
                                        <td>${grader.getUser().getUsername()}</td>
                                        <td></td>
                                        <td>
                                            <button class="pd-setting">${grader.getIsActive()}</button>
                                        </td>
                                        
                                        <td>${workshop.getWorkshop().getSubject()}</td>
                                        <td>${group_num}</td>
                                        <td></td>
                                        <td>
