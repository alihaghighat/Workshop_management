...
<html lang="en">
    <head>
        ...
        <title>Add a Course|/Workshop</title>
                        ...
                        <div class="col-lg-12 col-md-12  col-sm-12 col-xs-12">
                            <div class="sparkline10-list mt-b-30">
                                <div class="sparkline10-hd">
                                    <div class="main-sparkline10-hd bout-marj">
                                        <h1  >Add a course  <span class="basic-ds-n"></span></h1>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                    ...
                                                                    <input type="text" name="info" class="form-control basic-ele-mg-b-10 responsive-mg-b-10 redious" placeholder="Enter info" />
                                                                </div>
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <thead>
                                        <th></th>
                                            ...
                                            <th ></th>
                                            <th >Edite  and see preRequireds</th>
                                    </thead>
                                    <a href="#">
                                    <tbody>
                                     ...
                                     <c:forEach items="${all_courses}" var="course">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    <a href="${context}/course-preRequired?id=${course.getId()}" style="color: #000000;;"><button data-toggle="tooltip" title="see"  class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
