...
<html lang="en">
    <meta charset="utf-8">
        ...
        <title>Organizer forms |Workshop</title>
                                ...
                                <div class="sparkline10-list mt-b-30">
                                    <div class="sparkline10-hd">
                                        <div class="main-sparkline10-hd">
                                            <h1 >Add a form  <span class="basic-ds-n"></span></h1>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="basic-login-inner inline-basic-form">
                                                        <form method="GET" action="${context}/add-new-course">
                                                            <div class="form-group-inner">
                                                                <div class="row">
                                                                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                        ...
                                                                        <input type="text" name="subject" class="form-control basic-ele-mg-b-10 responsive-mg-b-10" placeholder="Enter subject" />
                                                                    </div>
                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            ...
                            <div class="add-product">
                                <a href="${context}/add-workshop">Add form</a>
                            </div>
                        </div>
                        <div class="sparkline13-graph">
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <tbody>
                                        <c:forEach items="${all_workshops}" var="workshop" varStatus="theCount" >
                                    <tr>
                                        <td>${workshop.getId()}</td>
                                        <td><a href="${context}/workshop-info?id=${workshop.getId()}">${workshop.getWorkshop().getSubject()}</a></td>
                                        <td><a href="${context}/organizer-grader?id=${workshop.getId()}">${graders_number.get(theCount.index)}</a></td>
                                        <td>
                                           <a href="${context}/show-student?id=${workshop.getId()}">${participants_number.get(theCount.index)}</a> 
                                        </td>
                                        <td>${workshop.getGroups().size()}</td>
                                        <td> ${workshop.getLocation()} ${dates.get(theCount.index)}</button></td>
                                        <td></td>
                                        <td></td>
                                        <td>
                                            <a href="${context}/course-preRequired?id=${course.getId()}" style="color: #000000;;"><button data-toggle="tooltip" title="see"  class="pd-setting-ed"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                                        </td>
                                    </tr>
                                        </c:forEach>
