                            ...
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <thead>
                                        ...
                                        <th>Name of graders</th>
                                        <th>Grader username </th>
                                        <th></th>
                                    ...
                                    <tr>
                                        <td>${request.getId()}</td>
                                        <td></td>
                                        <td>${request.getGrader().getUser().getFirstname()} ${request.getGrader().getUser().getLastname()}</td>
                                        <td>
                                           ${request.getGrader().getUser().getUsername()} 
                                        </td>
                                        <td></td>
                                        <td>${d.get(theCount.index)} </td>
                                        <td>
                                            ${request. isAccepted()}
                                        </td>
                                        
                                        <td>
                                        ${request.getInfo()} ${o_id}
                                        </td>
                                        <td>
                                        <a href="${context}/acceptGrader?id=${request.getId()}&o_id=${o_id}" style="color: #000000;;"><button data-toggle="tooltip" title="see"  class="pd-setting-ed"><i class="fa fa-check-circle" aria-hidden="true"></i></button></a>
                                        </td>
                                        
                                        <td>
                                          <a href="${context}/rejectGrader?id=${request.getId()}&o_id=${o_id}" style="color: #000000;;"><button data-toggle="tooltip" title="see"  class="pd-setting-ed"><i class="fa fa-trash" aria-hidden="true"></i></button></a> 
                                        </td>
                                    </tr>
                                        </c:forEach>
