                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="email" > Isername</th>
                                                <th data-field="phone" >Email</th>
                                                <th >Phone Number </th>
                                                <th>Gender</th>
                                                <th data-field="date" data-editable="true">Nationality</th>
                                                <th data-field="price" data-editable="true">Proceed</th>
                                        ...
                                        <c:forEach items="${students}" var="student">
                                            <tr>
                                                ...
                                                <td>${student.getUser().getContactPointsEmail()}</td>
                                                <td >
                                                ${student.getUser().getContactPointsPhoneNumber()}
                                                </td>
                                                <td>${student.getUser().getGender()}</td>
                                                <td>${student.getUser().getNationality()}</td>
                                                <td>$5455</td>
